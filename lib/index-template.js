...
const javascript = `
    ...
    for (var i = 0, max = filterButtons.length; i < max; i++) {
        filterButtons[i].onclick = function (event) {
            ...
            switch (isSelected.textContent) {
                case 'Passed': 
                    isSelected.classList.remove('is-primary');
                    break;
                case 'Failed': 
                    isSelected.classList.remove('is-danger');
                    break;
                case 'Skipped': 
                    isSelected.classList.remove('is-warning');
                    break;
                default: 
                    isSelected.classList.remove('is-link');    
            }
